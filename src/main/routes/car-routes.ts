...
import { makeDeleteCarcontroller } from '../factories/controllers/car/delete-car/delete-car-controller-factory'
...
export default (router: Router): void => {
  ...
  router.delete('/car/:id', adaptRoute(makeDeleteCarcontroller()))
}
